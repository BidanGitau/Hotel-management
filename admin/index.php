...
<head>
  <meta charset="UTF-8">
  <title>Weston Hotel ADMIN</title>
      ...
      <div id="login">
        ...
        <form method="post">
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fontawesome-user"></span><input type="text"  name="user" value="Username" onBlur="if(this.value == '') this.value = 'Username'" onFocus="if(this.value == 'Username') this.value = ''" required><
