...
<body>
	...
	<div class="banner-top">
		<div class="social-bnr-agileits">
			<ul class="social-icons3">
				<li><a href="https://www.facebook.com/bydan.gitau" class="fa fa-facebook icon-border facebook"> </a></li>
				<li><a href="https://twitter.com/bydangitau" class="fa fa-twitter icon-border twitter"> </a></li>
				<li><a href="https://twitter.com/bydangitau" class="fa fa-google-plus icon-border googleplus"> </a></li>
			</ul>
		</div>
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">bydangitau@gmail.com</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>0703947053</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Weston <span>Hotel</span>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Weston Hotel</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About </h3>
				<p class="about-para-w3ls">Best experience</p>
				...
				<div class="resp-tabs-container">
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Lucas Jimenez</h4>
							<span>Manager</span>
							<p>Best experience that you will ever have and best care</p>
					...
					<div class="tab2">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>The best of the receptionist you will come across .</p>
							<div class="social-bnr-agileits footer-icons-agileinfo">
								<ul class="social-icons3">
									<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
									<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Jason bond</h4>
							<span>Manager</span>
							<p>heve the experience of your life with a well recognized manager globally .</p>
							<div class="social-bnr-agileits footer-icons-agileinfo">
								<ul class="social-icons3">
									<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
									<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="tab4">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<span>Receptionist</span>
							<p>We strive to offer the best experience to our customers to ensure best services .</p>
							<div class="social-bnr-agileits footer-icons-agileinfo">
								<ul class="social-icons3">
									<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
									<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>have the experience of your life time </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Best comfort and servicesat your doorstep </p>
								<h5>Amie Bublitz</h5>
								<p>Nairobi</p>
							</div>
							<div class="clearfix"> </div>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">bydangitau@gmail.com</a></p>
				<p class="contact-agile1"><strong>Address :</strong>kilimani,
				</p>
				...
				<iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=nyeri&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
			</div>
			<div class="clearfix"></div>
		</div>
	</section>
	<!-- /contact -->
	<div class="copy">
		<p>© oldwizzle coop <a href="index.php">Weston Hotel</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
